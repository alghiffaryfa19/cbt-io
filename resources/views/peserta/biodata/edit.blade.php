    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mb-3">
                ...
                <div class="card-body">
                    <form action="{{route('data-peserta.update', $biodata->id)}}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$biodata->nisn}}" class="form-control" placeholder="NISN/NIS" name="nisn" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label><strong>Tempat, Tanggal Lahir</strong></label>
                                    <input type="text" value="{{$biodata->ttl}}" class="form-control" placeholder="Ngawi, 12 April 2002" name="ttl" />
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="alamat_rumah">{{$biodata->alamat_rumah}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$biodata->agama}}" placeholder="Agama" name="agama" />
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$biodata->no_wa}}" class="form-control" placeholder="+628..." name="no_wa" />
                                </div>
                            </div>
                        </div>
