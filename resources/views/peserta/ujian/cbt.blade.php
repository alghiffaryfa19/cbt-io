	...
	<div class="col-md-8">
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				...
				<input type="hidden" id="mapel_id" name="mapel_id" value="{{ $soal->mapel_id }}">
				...
				<ol type="a" class="option_test">
					<li>
						<div class="custom-control custom-radio">
							<input type="radio" id="radio1"  class="custom-control-input" name="answer" value="a" 
							 @if(CekYourAnswer($soal['soal_id'],Auth::user()->id) == 'a')
							 	{{ 'checked' }}
							 @endif
							/>
					...
					<li>
						<div class="custom-control custom-radio">
							...
							@if(CekYourAnswer($soal['soal_id'],Auth::user()->id) == 'b')
							 	{{ 'checked' }}
							 @endif
							/>
					...
					<li>
						<div class="custom-control custom-radio">
							...
							@if(CekYourAnswer($soal['soal_id'],Auth::user()->id) == 'c')
							 	{{ 'checked' }}
							 @endif
							/>
					...
					<li>
						<div class="custom-control custom-radio">
							...
							@if(CekYourAnswer($soal['soal_id'],Auth::user()->id) == 'd')
							 	{{ 'checked' }}
							 @endif
							/>
					...
					<li>
						<div class="custom-control custom-radio">
							...
							@if(CekYourAnswer($soal['soal_id'],Auth::user()->id) == 'e')
							 	{{ 'checked' }}
							 @endif
							/>
		...
		<div class="card shadow mb-4">
			...
			<div class="card-body">
				@foreach($daftarSoal as $data) 
					...
					@if(CekYakin($data->soal_id,Auth::user()->id) == 1)
								@php $status = 'btn-success'; @endphp
							@endif
							@if(CekRagu2($data->soal_id,Auth::user()->id) == 1)
